...
export default function BlogIndex() {
  return (
    <div className="page-transition px-5 py-10">
      <h1 className="mb-2 text-3xl font-extrabold" style={{ letterSpacing: "-0.03em" }}>
        Blog
      </h1>
      <p className="mb-8 text-muted">
        Tutorials, tips, and ecosystem deep-dives for OpenClaw.
      </p>
                ...
                <div className="mb-2 flex flex-wrap items-center gap-2 text-xs text-muted">
                  <span
                    className={`rounded-full px-2.5 py-0.5 font-medium ${
                      categoryColors[post.category] || "bg-primary/20 text-primary"
                    }`}
                  >
                    {post.category}
                  </span>
