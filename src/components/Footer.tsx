        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-6">
          ...
          <div className="flex gap-2">
            <a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 bg-white/5 text-muted transition hover:bg-white/10 hover:text-white"
              aria-label="GitHub"
            >
