    ...
    <footer className="border-t border-white/6 py-10">
      <div className="mx-auto max-w-[1200px] px-5">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-6">
          <div className="flex items-center gap-2 text-lg font-extrabold text-white" style={{ letterSpacing: '-0.03em' }}>
          ...
          <div className="flex gap-3">
            ...
            <a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/6 bg-white/5 text-muted transition hover:bg-white/10 hover:text-white"
              aria-label="GitHub"
            >
        ...
        <div className="mb-4 flex flex-wrap justify-center gap-4 text-sm text-muted">
          <Link href="/blog" className="transition-colors hover:text-white">Blog</Link>
          <Link href="/guides" className="transition-colors hover:text-white">Guides</Link>
          <Link href="/directory" className="transition-colors hover:text-white">Links</Link>
          <a
            href="https://github.com/openclaw/openclaw"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <p className="text-center text-xs opacity-50">
          © 2026 OpenClaw Community. Free · Open Source · Community-driven
        </p>
      </div>
    </footer>
  );
